 ...
 */
    ...
    (() => {
                ...
                if (0 === error) {
                    ...
                    if (ajax) {
                        ...
                        if (response.ok) {
                            ...
                            flsModules.popup.close("#popup-callback");
        ...
        if (inputMasks.length) flsModules.inputmask = Inputmask("+380-99-99-999").mask(inputMasks);
        ...
        let teamSlider;
        function initSlidersTeam() {
            if (document.querySelector(".team__slider")) teamSlider = new core(".team__slider", {
        ...
        let blogSlider;
        function initSlidersBlog() {
            if (document.querySelector(".blog__slider")) blogSlider = new core(".blog__slider", {
        ...
        function initSlidersOffer() {
            if (document.querySelector(".offer-slider")) blogSlider = new core(".offer-slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        const breakpointChecker = function() {
            if (true === breakpoint.matches) {
                if (void 0 !== teamSlider) teamSlider.destroy(true, true);
                if (void 0 !== blogSlider) blogSlider.destroy(true, true);
                if (void 0 !== offerSlider) offerSlider.destroy(true, true);
                return;
            } else if (false === breakpoint.matches) return initSlidersTeam(), initSlidersBlog(), 
            initSlidersOffer();
        };
        ...
        function headerScroll() {
            ...
            const headerShowTimer = header.dataset.scrollShow ? header.dataset.scrollShow : 1e3;
        ...
        if (document.querySelector(".like")) {
            ...
            for (let item of likes) {
                const like = item;
                const heart = like.querySelector(".like__icon");
                function setValue() {
                    item.querySelector(".like__value").textContent = item.dataset.like;
                }
                setValue();
                heart.addEventListener("click", (function() {
                    const like = this.parentElement;
                    if (like.classList.contains("like-checked")) {
                        if (Number(like.dataset.like)) {
                            like.dataset.like = Number(like.dataset.like) - 1;
                            like.classList.remove("like-checked");
                            setValue();
                        }
                    } else {
                        like.dataset.like = Number(like.dataset.like) + 1;
                        like.classList.add("like-checked");
                        setValue();
                    }
                }));
            }
        }
        function fousElement(targetElement, focusElement) {
            if (document.querySelector(targetElement)) {
                ...
                for (let item of targetElements) {
                    ...
                    element.addEventListener("focus", (function() {
                        if (this.closest(focusElement)) this.closest(focusElement).classList.add("_focus");
                    }));
                    element.addEventListener("blur", (function() {
                        if (this.closest(focusElement)) this.closest(focusElement).classList.remove("_focus");
                    }));
                }
            }
        }
        fousElement("._focus-elem", ".offer-service__item");
        fousElement("._focus-elem", ".item-posts__body");
        window["FLS"] = true;
        isWebp();
        menuInit();
        formSubmit();
